...
public class RotateLoadingLayout extends LoadingLayout {
    ...
    /**Header的容器右边提示文字*/
    private RelativeLayout mHeaderContainerText;
    /**箭头图片*/
    ...
    private void init(Context context) {
        ...
        mHeaderContainerText = (RelativeLayout) findViewById(R.id.pull_to_refresh_header_text);
    ...
    protected void onStateChanged(State curState, State oldState) {
        //Logger.e("pullrefresh", "rotateloadinglayout onStateChanged()");
