package com.xiaomizuche.view.pullrefresh;
...
import com.xiaomizuche.view.pullrefresh.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public interface OnRefreshListener<V extends View> {
         ...
         * @param isAutoRefresh 是自动刷新还是下拉刷新
         */
        void onPullDownToRefresh(final PullToRefreshBase<V> refreshView, boolean isAutoRefresh);
    ...
    /*是否是自动刷新,如果是自动刷新需要先加载缓存，手动刷新不需要加载缓存，直接请求网络*/
    ...
    protected void startRefreshing() {
        ...
        if (null != mRefreshListener) {
            ...
            postDelayed(new Runnable() {
                @Override
                public void run() {
                    mRefreshListener.onPullDownToRefresh(PullToRefreshBase.this,mIsAutoRefresh);
                }
            }, getSmoothScrollDuration());
        }
    }
     ...
     * @param isPullDown
     */
    public void doComplete(boolean isPullDown) {
        if(isPullDown){//是否下拉刷洗
